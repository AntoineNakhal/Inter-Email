"""Agent wrapper for email triage classification."""
...
from schemas import AgentEmail, TriageBatch
...
class TriageAgentRunner:
    ...
    def run(self, emails: list[AgentEmail]) -> TriageBatch:
        ...
        print(f"[triage] processing {len(emails)} emails")
