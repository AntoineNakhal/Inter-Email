"""Persistence helpers for thread-level manual review data in the Streamlit UI."""
...
def load_review_results(path: str | Path = DEFAULT_REVIEW_OUTPUT_PATH) -> dict[str, dict[str, Any]]:
    """Load review results keyed by thread id, returning an empty dict when missing/invalid."""
...
def upsert_review_result(
    ...
    """Insert/update one thread review record in memory."""
